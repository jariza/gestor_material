<h1 style="display: inline-block; width: 80%">Agenda de devolución de objetos</h1>
...
<?php
	foreach ($objetos as $v) {
		...
		echo "<tr><td>{$v['Objeto']['descripcion']}</td><td>{$v['Objeto']['cantidad']}</td><td>{$v['Objeto']['fechadevolucion']}</td><td>{$v['Objeto']['comentariosdevolucion']}</td></tr>\n";
	}
?>
</table>
<p>
